...
public class TriceratopsModel<T extends TriceratopsEntity> extends HierarchicalModel<T> {
	...
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
 	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(KnoxcraftMod.MODID, "triceratops"), "main");
