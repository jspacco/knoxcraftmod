...
public class TorosaurusModel<T extends TorosaurusEntity> extends HierarchicalModel<T> {
	...
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
 	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(KnoxcraftMod.MODID, "torosaurus"), "main");
	private final ModelPart body;
	private final ModelPart head;

	public TorosaurusModel(ModelPart root) {
